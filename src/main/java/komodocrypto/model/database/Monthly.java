...
public class Monthly {
    ...
    public Monthly(int monthly_id, String timestamp, String symbol, int exchange_id, double open, double low, double high, double close, double average, int volume) {
