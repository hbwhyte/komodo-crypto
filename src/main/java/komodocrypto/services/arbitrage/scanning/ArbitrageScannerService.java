...
public class ArbitrageScannerService {
    ...
    private static ArrayList<Exchange> defaultExchangeList;
    private static ArrayList<Exchange> allExchangesList;


    public ArbitrageScannerService() {
        this.defaultExchangeList = this.generateDefaultExchangeList();
    ...
    public ArrayList<Exchange> generateAllExchangesList() {
        ArrayList<Exchange> exchangesList = new ArrayList<Exchange>();
    ...
    public static ArrayList<Exchange> getDefaultExchangeList() {
        return defaultExchangeList;
    }

    public static void setDefaultExchangeList(ArrayList<Exchange> defaultExchangeList) {
        ArbitrageScannerService.defaultExchangeList = defaultExchangeList;
    }

    public static ArrayList<Exchange> getAllExchangesList() {
        return allExchangesList;
    }

    public static void setAllExchangesList(ArrayList<Exchange> allExchangesList) {
        ArbitrageScannerService.allExchangesList = allExchangesList;
    }
}
